...
userSchema.methods.setAdmin = function (admin: boolean) {
    this.admin = admin;
};
...
userSchema.methods.setNickname = function(nickname: string) {
	this.nickname = nickname;
}

userSchema.methods.updatePersonalInfo = function(info: any) {
	this.age = info.age;
	this.sex = info.sex;
	this.educationalQualification = info.educationalQualification;
}

userSchema.methods.setInfo = function(info: any) {
	this.age = info.age;
	this.sex = info.sex;
	this.educationalQualification = info.educationalQualification;
