...
gameRequestSchema.methods.getFullInfo = function () {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    sender = _a.sent();
                    return [4 /*yield*/, utils.getUserInfo(this.idReceiver)];
                case 2:
                    receiver = _a.sent();
                    return [2 /*return*/, {
                            id: this._id,
...
function newModel(idSender, idReceiver) {
