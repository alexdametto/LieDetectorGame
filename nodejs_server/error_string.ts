export class ErrorString {
  // User
	...
	static get USER_MISS_PASSWORD() {
		return "Password mancante";
	}
	static get USER_INVALID_PASSWORD() {
		return "Password non valida";
	}
	static get USER_EXIST() {
		return "Utente già presente";
	}
	static get USER_ONLINE() {
		return "Utente già online";
	}
	static get USER_NOT_ONLINE() {
		return "Utente non online";
	}
	static get USER_DELETE() {
		return "Utente eliminato";
	}
	static get NICKNAME_INVALID() {
		return "Nickname non valido";
	}
	static get USER_BANNED() {
